...
var execParamsUpdateScript = ' ' + urlUpdateScript + ' -O /root/update-ssl-certs.sh && chmod +x /root/update-ssl-certs.sh && echo \"0 04 * * * /root/update-ssl-certs.sh' + ' ' + appid + ' ' + token +'\" >> /var/spool/cron/root';
